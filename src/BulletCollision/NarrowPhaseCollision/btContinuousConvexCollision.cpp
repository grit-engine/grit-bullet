...
// -ffast-math breaks this function in gcc 6.2
// The effect was to cause cars to jump around in Grit.
// Small test case that demonstrates the problem at engine/tests/engine/cast_sphere/
